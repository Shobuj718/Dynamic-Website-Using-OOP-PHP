...
<?php  
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        elseif (in_array($file_ext, $permited) == false) {
            ...
            $query = "INSERT INTO tbl_slider( title, descrip, image) VALUES( '$title', '$descrip', '$upload_image')";
            $inserted_rows = $db->insert($query);
            if($inserted_rows){
                echo "<span class='success'>Slider Inserted successful.</span>";
            }
            else{
         ...
         <form action="addslider.php" method="post" enctype="multipart/form-data">
            <table class="form">
               ...
               <tr>
                    <td>Image link</td>
                    <td>
                        <input type="text" name="descrip" placeholder="Enter image link here..." class="medium" />
                    </td>
                </tr>
